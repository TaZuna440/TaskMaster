...
$errors = [];
if ($username === '' || strlen($username) > 50) $errors[] = 'Please provide a valid username (max 50).';
if (!filter_var($email, FILTER_VALIDATE_EMAIL) || strlen($email) > 100) $errors[] = 'Please provide a valid email (max 100).';
